...
/*global*/ case !root.BitSet                                                            : Reflect.defineProperty(root, 'BitSet', {value: bitset(), enumerable: !0}); break; default : console.error("'BitSet' is already defined on root object")}
}(this, function bitset() { "use strict";
/*es6*//*? } else { write('export {BitSet as CBitSet};\nexport default BitSet.prototype\n\n') } *//*<3*/
// int32 consts
const ZERO      =  0|0;
const ONE       =  1|0;
