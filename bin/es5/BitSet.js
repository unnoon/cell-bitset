...
!function (root, bitset) {
    var environments = true; /* istanbul ignore next */switch (environments) {
        ...
        /*node*/case (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object' && root === module.exports:module.exports = bitset();break;
...
}(undefined, function bitset() {"use strict";
    /**
    ...
    extend(BitSet.prototype, {
        ...
        /**
                                                        ...
                                                        */
        $hammingWeight: function $hammingWeight(w) {"@aliases: $popCount";
            {
                w -= w >>> 1 & 0x55555555 | 0;
        ...
        /**
                 ...
                 */
        add: function add() {
            {for (var _len = arguments.length, indices = Array(_len), _key = 0; _key < _len; _key++) {indices[_key] = arguments[_key];}
        ...
        /**
                 ...
                 */
        contains: function contains(mask) {"@aliases: fits";
            {
                var maskword;
        ...
        /**
                 ...
                 * @returns {BitSet} this
                 */
        exclusion: function exclusion(bitset) {"@aliases: symmetricDifference, xor";
            {
        ...
        /**
                 ...
                 */
        has: function has(index) {"@aliases: isMember";
            {
        ...
        /**
                 ...
                 * @returns {BitSet} this
                 */
        intersection: function intersection(bitset) {"@aliases: and";
            {
                for (var i = 0 | 0, max = this.words.length; i < max; i++)
                {
        ...
        /**
                 ...
                 */
        isSubsetOf: function isSubsetOf(bitset) {"@aliases: isContainedIn";
            {
        ...
        /**
                 ...
                 * @returns {BitSet}
                 */
        remove: function remove(___indices) {
            {
        ...
        /**
                 ...
                 * @returns {Array<number>|Uint8Array<int>|Uint16Array<int>|Uint32Array<int>}
                 */
        toBitArray: function toBitArray(type_) {
            {
                var arr;
        ...
        /**
                 ...
                 */
        toBitString: function toBitString(mode_) {
            {
                var output = '';
        ...
        /**
                 ...
                 */
        toString: function toString(mode) {"@aliases: stringify";
            {
                var output = '';
        ...
        /**
                 ...
                 */
        union: function union(bitset) {"@aliases: or";
            {
                if (bitset.length > this._length) {this.resize(bitset.length);}
